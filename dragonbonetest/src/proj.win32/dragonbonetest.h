...
class CC_DLL DragonbonetestPlayer : public CCObject
{
public:
...
private:
    static DragonbonetestPlayer *s_sharedInstance;
    static DragonbonetestPlayer *sharedInstance(void);
    static void purgeSharedInstance(void);

    DragonbonetestPlayer(void);
