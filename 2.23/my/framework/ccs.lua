...
widget_table = 
{
    [UI_WIDGET]      = { name = "UIWidget",      create = function() return Widget:create() end,      extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_BUTTON]      = { name = "UIButton",      create = function() return Button:create() end,      extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_CHECKBOX]    = { name = "UICheckBox",    create = function() return CheckBox:create() end,    extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_IMAGEVIEW]   = { name = "UIImageView",   create = function() return ImageView:create() end,   extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_LABEL]       = { name = "UILabel",       create = function() return Label:create() end,       extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_LABELATLAS]  = { name = "UILabelAtlas",  create = function() return LabelAtlas:create() end,  extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_LABELBMFONT] = { name = "UILabelBMFont", create = function() return LabelBMFont:create() end, extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_LOADINGBAR]  = { name = "UILoadingBar",  create = function() return LoadingBar:create() end,  extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_PANEL]       = { name = "UILayout",      create = function() return Layout:create() end,      extend = function(uiwidget) return CCSLayoutExtend.extend(uiwidget) end},
    [UI_SCROLLVIEW]  = { name = "UIScrollView",  create = function() return ScrollView:create() end,  extend = function(uiwidget) return CCSLayoutExtend.extend(uiwidget) end},
    [UI_SLIDER]      = { name = "UISlider",      create = function() return Slider:create() end,      extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_TEXTFIELD]   = { name = "UITextField",   create = function() return TextField:create() end,   extend = function(uiwidget) return CCSWidgetExtend.extend(uiwidget) end},
    [UI_DRAGPANEL]   = { name = "UIDragPanel",   create = function() return DragPanel:create() end,   extend = function(uiwidget) return CCSLayoutExtend.extend(uiwidget) end},
    [UI_LISTVIEW]    = { name = "UIListView",    create = function() return ListView:create() end,    extend = function(uiwidget) return CCSLayoutExtend.extend(uiwidget) end},
    [UI_LISTVIEWEX]  = { name = "UIListViewEx",  create = function() return ListViewEx:create() end,  extend = function(uiwidget) return CCSLayoutExtend.extend(uiwidget) end},
    [UI_PAGEVIEW]    = { name = "UIPageView",    create = function() return PageView:create() end,    extend = function(uiwidget) return CCSLayoutExtend.extend(uiwidget) end},
 }

function ccs.layer()
	local layer = CCSLayerExtend.extend(TouchGroup:create())
	return layer
end
